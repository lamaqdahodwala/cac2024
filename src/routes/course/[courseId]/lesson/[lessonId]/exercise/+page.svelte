<script lang="ts">
	...
	import FileSystem from '../../../../../playground/FileSystem.svelte';
	import {
		CodeEvaluationBuilder,
		FunctionConstructorStrategy
	} from '../../../../../playground/CodeEval';
	import Log from '../../../../../playground/Log.svelte';
	import { MutatedCategory } from '$lib/blocks/Mutated';
	import type { PageData } from './$types';

	let toolbox = new ToolboxCreator([
		LoadingDataCategory,
		DataCleaningCategory,
...
<button on:click={() => (instructionsExpanded = !instructionsExpanded)}>View Instructions</button>

{#if instructionsExpanded}
	<div class="container">
		<p>Instructions: {data.exerciseParams.instructions}</p>
	</div>
{/if}
