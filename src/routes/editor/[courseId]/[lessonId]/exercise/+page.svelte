...
<form method="post" use:enhance>
  <input type="text" hidden value={id} name="id">
	<p>Instructions: <input type="text" bind:value={instructions} name="instructions" class="input" /></p>
  <br>
	<p>Pass Requirement: <input type="number" class="input" min="0" max="100" bind:value={passRequirement} name="passRequirement" /></p>
  <br>
	<p>
