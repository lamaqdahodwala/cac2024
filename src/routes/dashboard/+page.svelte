<script lang="ts">
    ...
    function initializeCommunityPosts() {
        communityPosts = [
            { user: "AIEnthusiast", content: "Just completed the Neural Networks course. Mind-blowing!", likes: 15, avatar: "https://i.pravatar.cc/150?img=1" },
            { user: "DataScientist42", content: "Anyone want to form a study group for the RL course?", likes: 8, avatar: "https://i.pravatar.cc/150?img=2" },
            { user: "MLNewbie", content: "Struggling with backpropagation. Any tips?", likes: 3, avatar: "https://i.pravatar.cc/150?img=3" },
        ];
    }
    ...
    function addCommunityPost(content: string) {
        communityPosts = [{ user: "You", content, likes: 0, avatar: "https://i.pravatar.cc/150?img=4" }, ...communityPosts];
        newCommunityPost = '';
    }
                ...
                <section class="section discover-courses" in:fade>
                    ...
                    <div class="field">
                        <div class="control has-icons-left">
                            <input class="input is-rounded" type="text" placeholder="Search courses or tags" bind:value={searchTerm}>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-content">
                                        ...
                                        <p class="subtitle is-6">
                                            <span class="tag is-info is-light">{course.difficulty}</span>
                                        ...
                                        <div class="level">
                                            ...
                                            <div class="level-right">
                                                <div class="level-item">
                                                    <button class="button is-primary is-rounded is-fullwidth animated-button" on:click={() => { selectedCourseId = course.id; addActiveCourse(); }}>
                                                        <span class="icon">
            ...
            <div class="modal-card">
                ...
                <section class="modal-card-body">
                    ...
                    <div class="quiz-question">
                        ...
                        {#if quizResult}
                            <div class="quiz-result" class:is-correct={quizResult.startsWith('Correct')} class:is-incorrect={quizResult.startsWith('Incorrect')}>
                                <p>{quizResult}</p>
                            </div>
                        {/if}
                    {/if}
                ...
                <footer class="modal-card-foot">
                    <button class="button is-primary is-rounded" on:click={submitQuiz} disabled={!userAnswer}>Submit Answer</button>
                    <button class="button is-info is-rounded" on:click={() => { showQuiz = false; startQuiz(); }}>New Question</button>
        ...
        <div class="modal is-active">
            ...
            <div class="modal-card">
                ...
                <section class="modal-card-body">
                    ...
                    <button class="button is-primary is-rounded" on:click={() => addCommunityPost(newCommunityPost)}>Post</button>
                    <hr>
